...
star_path=/home/lab/miniconda3/envs/bioinfo_env/bin/STAR
...
N_A=8
N_mismatch=1
star_options='--outFilterMultimapNmax 1 --outFilterMismatchNmax 999 --clip3pAdapterSeq AAAAAAAAACAAAAAAAAACAAAAAAAAAA --clip3pAdapterMMp 0.2' # no multimappers reported, no mismatch filter, and poly(A) clipped
